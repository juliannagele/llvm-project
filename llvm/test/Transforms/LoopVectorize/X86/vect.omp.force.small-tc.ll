...
; CHECK-NEXT:    [[TMP16:%.*]] = add i64 [[INDEX8]], 0
; CHECK-NEXT:    [[TMP17:%.*]] = getelementptr inbounds float, ptr [[B]], i64 [[TMP16]]
...
; CHECK-NEXT:    [[TMP19:%.*]] = getelementptr inbounds float, ptr [[A]], i64 [[TMP16]]
...
||||||| parent of d7a1388640eb (Revert "[LV] Vectorize Epilogues for loops with small VF but high IC (#108190)")
; CHECK-NEXT:    br i1 false, label [[FOR_END:%.*]], label [[VEC_EPILOG_ITER_CHECK:%.*]]
; CHECK:       vec.epilog.iter.check:
; CHECK-NEXT:    br i1 false, label [[VEC_EPILOG_SCALAR_PH]], label [[VEC_EPILOG_PH]]
; CHECK:       vec.epilog.ph:
...
>>>>>>> d7a1388640eb (Revert "[LV] Vectorize Epilogues for loops with small VF but high IC (#108190)")
...
||||||| a8538b913857 ([LV] Vectorize Epilogues for loops with small VF but high IC (#108190))
; CHECK-NEXT:    call void @llvm.masked.store.v8f32.p0(<8 x float> [[TMP6]], ptr [[TMP5]], i32 4, <8 x i1> [[TMP1]]), !llvm.access.group [[ACC_GRP7]]
...
; CHECK-NEXT:    [[INDEX_NEXT]] = add i64 [[INDEX]], 8
>>>>>>> parent of a8538b913857 ([LV] Vectorize Epilogues for loops with small VF but high IC (#108190))
